											...
											<div class="chart-data-selector" id="salesSelectorWrapper">
												...
												<div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
													...
													<script>
														...
														// See: <?php echo base_url(); ?>assets/porto/javascripts/dashboard/examples.dashboard.js for more settings.
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="<?php echo base_url(); ?>assets/porto/images/!logged-user.jpg">
												</div>
														...
														<ul class="simple-user-list mb-xlg">
															<li>
																<figure class="image rounded">
																	<img src="<?php echo base_url(); ?>assets/porto/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle">
																</figure>
															...
															<li>
																<figure class="image rounded">
																	<img src="<?php echo base_url(); ?>assets/porto/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle">
																</figure>
															...
															<li>
																<figure class="image rounded">
																	<img src="<?php echo base_url(); ?>assets/porto/images/!sample-user.jpg" alt="Joe Junior" class="img-circle">
																</figure>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="<?php echo base_url(); ?>assets/porto/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="<?php echo base_url(); ?>assets/porto/images/projects/project-4.jpg">
																<span class="zoom">
