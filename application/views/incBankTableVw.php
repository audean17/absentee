    ...
    echo $linkForm;
											...
											<div class="panel-body">
													...
													<!-- <div class="form-group">
														<label class="col-sm-3 control-label">Bank ID</label>
														<div class="col-sm-9">
															<input type="text" name="bankId" class="form-control" placeholder="Type bank ID..." required/>
														</div>
													</div> -->
                          <div class="form-group">
                          ...
                          <div class="form-group">
							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									<thead>
										<tr>
											<th style="width:20px;">Bank ID</th>
											<th style="width:80px;">Bank Parent</th>
											<th style="width:80px;">Bank Name</th>
											<th style="width:120px;">Address</th>
                      <th style="width:20px;">Telp</th>
                      <th style="width:20px;">Fax</th>
                      <th style="width:20px;">Description</th>
                                    ...
                                    ?>
										<tr class="gradeX">
											...
											<td><?php echo $row->parent_bank;?></td>
