    ...
    echo $linkForm;
											...
											<header class="panel-heading">
												<h2 class="panel-title">Add data user group</h2>
											</header>
											<div class="panel-body">
<!--
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
                                    ...
                                    ?>
										<tr class="gradeX">
											...
											<td class="actions">
												<a href="http://fauzan.net" onclick="javascript:showFormEdit('<?php echo site_url("usergroup/change/".$row->group_id."")?>','<?php echo $myDataSplit;?>');return false;"  title="Edit for this row"><i class="fa fa-pencil"></i></a>&nbsp;
												<a href="http://fauzan.net" onclick="javascript:confirmationAlert('<?php echo site_url("usergroup/delete/".$row->group_id."")?>','Are you sure you want to delete this row?');return false;" title="delete for this row"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
                                        <?php } ?>
									</tbody>
