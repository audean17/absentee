...
if ($err) {
	...
	$valReportTitle="<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
			<tr>
				<td colspan=\"3\" style=\"text-align:left; text-transform:uppercase; font-size:11px; font-weight:bold;font-family:Arial, Helvetica, sans-serif;\">BERIKUT INI ADALAH LIST INFORMASI TENTANG PERMOHONAN RUMAH KHUSUS BERDASARKAN PERUNTUKAN, SILAHKAN KLIK DUA KALI UNTUK MELIHAT DETAIL DATA</td>
			</tr>
			<tr>
...
$myProcessPengajuan2="\',800,600);return false;\\\"";
	...
	if (strlen($userName)>0 or $userName<>"") {
			$valQuery="
				select '1' as group_total, a.request_id, CONCAT('<a id=\"myLink\" title=\"Prosess Edit\" href=\"#\" ".$myProcessEdit."',request_id,'".$myProcessEdit2."',' class=\"menuDownload\" target=\"new\">',a.umum_pengusul,'</a>')  as umum_pengusul,b.propinsi_name,a.umum_tgl_surat,a.umum_kontak_person,
...
//				order by group_total,propinsi_name asc,kabupaten_kota_name asc, umum_tgl_surat
	...
	if (strlen($userName)>0 or $userName<>"") {
			...
			$valRptColumnHeader="
				<tr class=\"rowHeader\">
						<td class=\"headerLeft\" colspan=\"13\" style=\"border-left:1px solid; border-right:1px solid; border-top:1px solid;\">TARGET GROUP</td>
					</tr>
					<tr class=\"rowHeader\">
						...
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Provinsi</td>
			</td>
						...
						<td class=\"headerRightU\" style=\"border-right:1px solid;border-left:1px solid;border-top:1px solid;text-align:center;\" rowspan=\"2\">Proses Pengajuan</td></tr>
<tr class=\"rowHeader\">
			...
			$valArrTempColDet1="
				<tr class=\"rowDetail\" #my_link# style=\"cursor:pointer; background-color:#request_type_desc#;\">
						...
						<td class=\"detailLeftU\"  style=\"border-left:1px solid;\">#propinsi_name#</td>
			...
			$valArrTempColSum1="<tr class=\"rowGroup\">
						<td style=\"border-left:1px solid; background-color:#9FBC74;\" class=\"groupLeftU\"  colspan=\"5\">#sum:target_name#</td>
