...
if ($err) {
	...
	$valReportTitle="<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
			<tr>
				<td colspan=\"3\" style=\"text-align:left; text-transform:uppercase; font-size:11px; font-weight:bold;font-family:Arial, Helvetica, sans-serif;\">BERIKUT INI ADALAH LIST INFORMASI TENTANG PERMOHONAN RUMAH KHUSUS, SILAHKAN KLIK DUA KALI UNTUK MELIHAT DETAIL DATA</td>
			</tr>
			<tr>
	...
	if (strlen($anotherCriteria)>0 or $anotherCriteria<>"") {
	  $addQuery.=$anotherCriteria;	
	} else {
	  $addQuery.="";
	}	
...
$myProcess="ondblclick=\\\"javascript:openPopUpForm2(\'master/requestForm/pgRequestRumahDetailVw.php?rid=";
$myProcess2="\',800,600);\\\"";

$myDetail="href=\\\"javascript:location.href =\'".site_url("headline/requestDetail/")."/";
$myDetail2="\';\\\"";
...
$myProcessEdit="onClick=\\\"javascript:openPage(\'master/requestForm/pgRequestFormVw.php?action=retrieveFromBrowser&id=";
$myProcessEdit2="\');return false;\\\"";
// CONCAT('<a id=\"myLink\" title=\"Prosess Edit\" href=\"#\" ".$myProcessEdit."',request_id,'".$myProcessEdit2."',' class=\"menuDownload\" target=\"new\">',a.umum_pengusul,'</a>')  as umum_pengusul
$myProcessEdit="";
$myProcessEdit2="";


$myProcessPengajuan="onClick=\\\"javascript:openPopUpForm2(\'master/processRequest/pgProcessRequestVw.php?action=retrieveFromBrowser&id=";
$myProcessPengajuan2="\',800,600);return false;\\\"";


	if (strlen($userName)>0 or $userName<>"") {
			$valQuery="
				select '1' as group_total, a.request_id, umum_pengusul,b.propinsi_name,a.umum_tgl_surat,a.umum_kontak_person,
	...
	adm_total_score, case when is_process = 1 then concat('OK - ',year_periode_process) else CONCAT('<a id=\"myLink\" title=\"Prosess Pengajuan\" href=\"#\" ".$myProcessPengajuan."',request_id,'".$myProcessPengajuan2."',' class=\"menuDownload\" target=\"new\">Proses</a>') end as prosess_pengajuan,
	case when adm_total_score < 80 then 'Belum Lengkap' else 'Data Lengkap' end as result_desc, 
	...
	case when attachment_file_path='' then 'belum ada data' else CONCAT('<a href=\"images/berkas/',attachment_file_path,'\" class=\"menuDownload\" target=\"new\">Lihat Berkas</a>') end as lihat_berkas, CONCAT('".$myProcess."',a.request_id,'".$myProcess2."') as my_link, CONCAT('<a id=\"myLink\" title=\"Prosess Pengajuan\"  ".$myDetail."',request_id,'".$myDetail2."',' class=\"menuDownload\" target=\"new\">Detail Data</a>') as my_detail,kabupaten_kota_name, case when a.request_type='1002' then '#f7ab28' else '#ffffff' end as request_type_desc, 
...
//				order by group_total,propinsi_name asc,kabupaten_kota_name asc, umum_tgl_surat
	...
	$valQueryFilter="";
	$valArrRptFieldStructFieldName="group_total,request_id,umum_pengusul,propinsi_name,umum_tgl_surat,umum_kontak_person,target_name,umum_lokasi,umum_unit,umum_luas_lahan,adm_val_surat_pemohonan,adm_val_proposal,adm_val_surat_dukungan,adm_val_surat_pernyataan,adm_val_surat_keterangan_dinas,adm_val_sertifikat_tanah,adm_val_harga_satuan_kota,adm_val_surat_pengantar_propinsi,adm_total_score,result_desc,lihat_berkas,my_link,kabupaten_kota_name,request_type_desc,my_color_result,prosess_pengajuan,col_syarat,val_syarat,status_vertek,col_vertek,val_vertek,my_detail";
	$valArrRptFieldStructFieldType="string,string,string,string,string,string,string,string,sumint,string,int,int,int,int,int,int,int,int,int,string,string,string,string,string,string,string,string,string,string,string,string,string";
	$valArrRptStructGroup0="group_total,group_total,colGroup0,colSum0,true";
	$valArrRptStructGroup1="propinsi_name,propinsi_name,colGroup1,colSum1,true";
	$valArrRptStructGroup2="";
	$valArrRptStructGroup3="";

	if (strlen($userName)>0 or $userName<>"") {
			$valArrColumnWidth="120,220,80,80,260,35,60,90,50,50,50,90,50";
		
			$valRptColumnHeader="
				<tr class=\"rowHeader\">
						<td class=\"headerLeft\" colspan=\"13\" style=\"border-left:1px solid; border-right:1px solid; border-top:1px solid;\">NAMA PROPINSI</td>
					</tr>
					<tr class=\"rowHeader\">
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Kabupaten</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Pengusul</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Kontak Person</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Target Group</td>
			</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Lokasi</td>
						
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Unit</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Luas Lahan</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;text-align:center;\" colspan=\"3\">Hasil Verifikasi</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Status<br>Vertek</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Data Permohonan</td>
						<td class=\"headerLeftU\" style=\"border-right:1px solid;border-left:1px solid;border-top:1px solid;text-align:center;\" rowspan=\"2\">Proses Pengajuan</td></tr>
<tr class=\"rowHeader\">
			...
			$valArrTempColDet1="
				<tr class=\"rowDetail\" #my_link# style=\"cursor:pointer; background-color:#request_type_desc#;\">
						<td style=\"border-left:1px solid; \" class=\"detailLeftU\" >#kabupaten_kota_name#</td>
						<td style=\"border-left:1px solid;\" class=\"detailLeftU\" >#umum_pengusul#</td>
						...
						<td class=\"detailRightU\"  style=\"border-left:1px solid;background-color:#my_color_result#;text-align:center;\">#adm_total_score#%</td>
						...
						<td class=\"detailLeftU\" style=\"border-left:1px solid;\">#my_detail#</td>
						<td class=\"detailLeftU\" style=\"border-right:1px solid;border-left:1px solid;\">#prosess_pengajuan#</td>
					</tr>";
			$valArrTempColSum0=" 		
				<tr class=\"rowGroup\">
			...
			$valArrTempColSum2="<tr class=\"rowGroup\">
			...
			$valRptColumnHeader="
				<tr class=\"rowHeader\">
					...
					<tr class=\"rowHeader\">
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Kabupaten</td>
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Pengusul</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Kontak Person</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Target Group</td>
			</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;\" rowspan=\"2\">Lokasi</td>
						
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;text-align:right;\" rowspan=\"2\">Unit</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;text-align:right;\" rowspan=\"2\">Luas Lahan</td>
						<td class=\"headerRightU\" style=\"border-left:1px solid;border-top:1px solid;text-align:right;\" colspan=\"3\">Nilai Verifikasi</td>
