...
if ($err) {
	...
	$valReportTitle="<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
			<tr>
				<td colspan=\"3\" style=\"text-align:left; text-transform:uppercase; font-size:11px; font-weight:bold;font-family:Arial, Helvetica, sans-serif;\">SUMMARY REPORT REQUEST BY PROVINSI-KABUPATEN</td>
			</tr>
	...
	if (strlen($userName)>0 or $userName<>"") {
			$valQuery="
				select '1' as group_total, count(a.request_id) as jumlah_usulan, b.propinsi_name, kabupaten_kota_name, sum(a.umum_unit) jumlah_unit
					from tp_request2 a 
					...
					group by propinsi_name,kabupaten_kota_name
...
//				order by group_total,propinsi_name asc,kabupaten_kota_name asc, umum_tgl_surat
	...
	$valQueryFilter="";
	$valArrRptFieldStructFieldName="group_total,propinsi_name,kabupaten_kota_name,jumlah_usulan,jumlah_unit";
	...
	if (strlen($userName)>0 or $userName<>"") {
			...
			$valRptColumnHeader="
				<tr class=\"rowHeader\">
						<td class=\"headerLeft\" colspan=\"3\" style=\"border-left:1px solid; border-right:1px solid; border-top:1px solid;\">NAMA PROPINSI</td>
					</tr>
					<tr class=\"rowHeader\">
						<td class=\"headerLeftU\" style=\"border-left:1px solid;border-top:1px solid;text-align:center;\" >Kabupaten</td>
			...
			$valArrTempColSum1="<tr class=\"rowGroup\">
						<td style=\"border-left:1px solid; background-color:#9FBC74;\" class=\"groupLeftU\"  >#sum:propinsi_name#</td>
