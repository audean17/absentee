...
class myForm {
	...
	public function test($page_title, $file_name, $right_width=0, $right_valign="center", $contents_valign="center") {
	...
	public function getFileName() {  //fauzan
		return $this->pv['file_name'];
    }
